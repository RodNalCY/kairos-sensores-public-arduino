...
void setup() {
  ...
  Serial.print("Setting AP-KairOSPLIBRE configuration ... ");
  Serial.println(WiFi.softAPConfig(local_IP, gateway, subnet) ? "Ready" : "Failed!");
  Serial.print("Setting AP-KairOSPLIBRE ... ");
  Serial.println(WiFi.softAP("AP-KairOSPLIBRE", "987654321") ? "Ready" : "Failed!");

  Serial.print("AP-KairOSXO IP address = ");

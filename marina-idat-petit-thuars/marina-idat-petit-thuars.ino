...
String codigoPM = "LPETITUARSPM01";
String codigoDT = "LPETITUARSTEMP01";
String codigoDH = "LPETITUARSHUM01";
//String codigoCO = "LPETITUARSCO1";
...
void setup() {
  ...
  Serial.print("Setting AP-KairOS-Petit-Thuars configuration ... ");
  Serial.println(WiFi.softAPConfig(local_IP, gateway, subnet) ? "Ready" : "Failed!");
  Serial.print("Setting AP-KairOS-Petit-Thuars ... ");
  Serial.println(WiFi.softAP("AP-KairOS-Petit-Thuars", "123456789") ? "Ready" : "Failed!");

  Serial.print("AP-KairOS-Petit-Thuars IP address = ");
...
void loop() {
  ...
  if (pms.read(data)) {
    ...
    if (currentMillis_2 - previousMillis_2 >= 10000) { //Definimos el tiempo de envio 360000
...
void getSaveHost() {
  ...
  /////////////////////////////////////////////////////////////////////////////////////////////
  if (currentMillis - previousMillis >= 10000) { //Definimos el tiempo de envio

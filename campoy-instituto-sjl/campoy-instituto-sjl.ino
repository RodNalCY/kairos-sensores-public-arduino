...
String codigoPM = "SJLCAMPM2501";
String codigoDT = "SJLCAMTEMP01";
String codigoDH = "SJLCAMHUMD01";
...
void setup() {
  ...
  Serial.print("Setting AP-KairOS-SJL configuration ... ");
  Serial.println(WiFi.softAPConfig(local_IP, gateway, subnet) ? "Ready" : "Failed!");
  Serial.print("Setting AP-KairOS-SJL ... ");
  Serial.println(WiFi.softAP("AP-KairOS-SJL", "987654321") ? "Ready" : "Failed!");

  Serial.print("AP-KairOS-SJL IP address = ");
...
void loop() {
  ...
  if (pms.read(data)) {
    ...
    if (currentMillis_2 - previousMillis_2 >= 5000) { //Definimos el tiempo de envio 360000

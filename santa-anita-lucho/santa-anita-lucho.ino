...
String codigoPM = "SANTANITAPM251";
String codigoDT = "SANTANITATEMP1";
String codigoDH = "SANTANITAHUMED1 ";
...
String token = "TeamKairos.ky.029a52be43c7f152fb0f47cd581df3d3";
float medidaPM = 0;
float medidaTEM = 0;
float medidaHUM = 0;
double AQI_PM25 = 0;
...
void setup() {
  ...
  Serial.print("Setting AP-KairOS-LUCHO configuration ... ");
  Serial.println(WiFi.softAPConfig(local_IP, gateway, subnet) ? "Ready" : "Failed!");
  Serial.print("Setting AP-KairOS-LUCHO ... ");
  Serial.println(WiFi.softAP("AP-KairOS-LUCHO", "987654321") ? "Ready" : "Failed!");

  Serial.print("AP-KairOS-LUCHO IP address = ");
